...
def load_LLM(gemini_api_key):
    ...
    llm = ChatGoogleGenerativeAI(model="gemini-2.5-flash", temperature=.5, google_api_key=gemini_api_key)
    return llm
...
if draft_input:
    ...
    improved_redaction = llm.invoke([HumanMessage(content=prompt_with_draft)])
